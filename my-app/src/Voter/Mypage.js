            ...
            <TableBody>
              {data.map((x, i) => (
                <TableRow key={i}>
                  ...
                  <TableCell align="left">{x.createdAt}</TableCell>
                  <TableCell align="left">{x.content}</TableCell>
                  <TableCell align="left">{x.candidate}</TableCell>
                  <TableCell align="left">{x.win}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
